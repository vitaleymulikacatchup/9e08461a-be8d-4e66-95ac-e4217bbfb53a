...
export const metadata: Metadata = {
  title: "Magazine Store - Premium Publications & Subscriptions",
  description: "Browse and subscribe to premium magazines across fashion, technology, lifestyle, and more. Fast delivery, quality guaranteed.",
  keywords: "magazines, subscriptions, publications, fashion magazines, tech magazines",
  robots: {
    index: true,
    follow: true
  },
  openGraph: {
    title: "Magazine Store - Premium Publications",
    description: "Discover curated magazine selections with fast delivery to your door",
    siteName: "Magazine Store",
    type: "website"
  }
};
